...
############# toolbar ##############
#print(type(tk.font.families()))         # tuple class
...
font_size['values'] = tuple(range(8,90,2))
font_size.current(4)
...
def change_font(main_application):      # main application is passed due to bind func 
...
def align_left():
    text_contect = text_editor.get(1.0,'end')
    text_editor.tag_config('left',justify=tk.LEFT)
    text_editor.delete(1.0,tk.END)
    text_editor.insert(tk.INSERT,text_contect,'left')
...
def align_center():
    ...
    text_editor.delete(1.0,tk.END)
    text_editor.insert(tk.INSERT,text_contect,'center')
...
def align_right():
    ...
    text_editor.delete(1.0,tk.END)
    text_editor.insert(tk.INSERT,text_contect,'right')
...
def find_func(event=None):
    ...
    # frame
    find_replace_frame = ttk.LabelFrame(find_dialogue,text='Find/Replace')
    find_replace_frame.pack(pady=20)

    # labels 
    find_label = ttk.Label(find_replace_frame,text='Find :')
    replace_label = ttk.Label(find_replace_frame,text='Replace :')

    # entry
    find_entry = ttk.Entry(find_replace_frame,width=30)
    replace_entry = ttk.Entry(find_replace_frame,width=30)

    # button
    find_button = ttk.Button(find_replace_frame,text='Find',command=find)
    replace_button = ttk.Button(find_replace_frame,text='Replace',command=replace)
